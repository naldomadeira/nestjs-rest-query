...
<Callout type="info">
  Este interceptor só é necessário para testar filtros pela interface do Swagger
  UI. Clientes externos (Postman, aplicações frontend, etc.) constroem a URL
  diretamente e não precisam dele. A seção [Swagger](/docs/swagger) explica o
  cenário completo.
</Callout>

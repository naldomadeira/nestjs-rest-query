...
export class UsersBusiness {
  ...
  list(
    ...
    // `as never`: QueryBuilderService está tipado contra ObjectLiteral (TypeORM)
    // por compatibilidade. Em runtime o adapter é agnóstico.
...
this.qb.execute(prismaSource as never, query, rules, (qb) => {
  // `qb` é o accumulator interno PrismaQB:

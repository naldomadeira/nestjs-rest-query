...
- **Migrando de uma versão anterior?** Veja o [guia de migração 1.x → 2.x](https://github.com/naldomadeira/nestjs-rest-query/blob/main/MIGRATION.md) para detalhes sobre peer dependencies opcionais, mudanças no shape do resultado e mensagens de erro do adapter.
